...
const ProductCard: React.FC<ProductCardProps> = ({ title, price, image }) => {
  return (
    <div className="border border-pink-300 bg-white rounded-[140px] bg-opacity-70  shadow-lg p-4 transition-transform transform hover:scale-105 flex flex-col items-center mx-3">
