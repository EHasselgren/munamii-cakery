...
const Products: React.FC = () => {
  ...
  return (
    <PageCard>
      ...
      <ProductSlider title="Delicious Cupcakes" products={cupcakes} settings={homeSliderSettings} slidesToShow={6} />
      <ProductSlider title="Elegant Wedding Cakes" products={weddingCakes} settings={homeSliderSettings} slidesToShow={6} />
      <img
